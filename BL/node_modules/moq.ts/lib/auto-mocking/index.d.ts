...
declare const _default: ({
    ...
    deps: (typeof PropertyKeyFormatter | typeof FunctionFormatter | typeof MethodFormatter)[];
} | {
    ...
    deps: (typeof PropertyKeyFormatter | typeof FunctionFormatter | typeof MethodFormatter | typeof NamePrefixProvider)[];
} | {
    ...
    deps: (import("../static.injector/injection_token").InjectionToken<import("../moq").IMock<unknown>> | (Optional | import("../static.injector/injection_token").InjectionToken<import("../moq").IMock<unknown>>)[])[];
} | {
